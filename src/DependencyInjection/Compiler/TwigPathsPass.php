...
namespace Nowo\SlideToConfirmBundle\DependencyInjection\Compiler;
 ...
 * application overrides (templates/bundles/NowoSlideToConfirmBundle/) are consulted first.
 */
final class TwigPathsPass implements CompilerPassInterface
{
    private const TWIG_NAMESPACE = 'NowoSlideToConfirmBundle';
